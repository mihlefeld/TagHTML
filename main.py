...
@click.option("--comp_directory", help="Directory where the necessary files are place and everything will be generated to", default="Competitions/DDD24")
...
def main(comp_id, comp_directory, height, width, update, template_path, exp_emoji_path, format):
    if update:
        update_data()
